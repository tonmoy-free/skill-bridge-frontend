...
export const categoryService = {
    createCategory: async function (updateData: Partial<CategoryData>, options?: ServiceOptions) {
        try {
    ...
    updateCategoryById: async function (id: string, updateData: Partial<CategoryData>, options?: ServiceOptions) {
        try {
            const url = `${API_URL}/category/${id}`; // ডাইরেক্ট স্ট্রিং ইন্টারপোলেশন
