...
export const studentService = {
    ...
    getSingleStudentById: async function (id: string, options?: ServiceOptions) {
        try {
            const url = new URL(`${API_URL}/dashboard/user/${id}`);
    ...
    updateStudentProfileById: async function (id: string, updateData: Partial<UserData>, options?: ServiceOptions) {
        try {
            const url = `${API_URL}/dashboard/user/student/${id}`; // ডাইরেক্ট স্ট্রিং ইন্টারপোলেশন
