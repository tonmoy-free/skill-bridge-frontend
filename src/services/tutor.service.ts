...
import { UserData } from "./manageUser.service";
...
export const tutorService = {
    ...
    getTutorProfileByIdForCommonLayout: async function (id: any, options?: ServiceOptions) {
        const { data } = await userService.getSession();
    ...
    getSingleTutorUserById: async function (id: string, options?: ServiceOptions) {
        try {
            const url = new URL(`${API_URL}/tutors/tutors-profile/user/${id}`);
