                    ...
                    <div className="relative">
                        ...
                        <div className="bg-white dark:bg-slate-800 w-[220px] h-[230px] absolute top-40 -left-20 rounded-md shadow-2xl border dark:border-slate-700">
                            ...
                            <div className="pl-5 space-y-3 pr-5">
                                {[
                                    { name: "Rahmi Khan", img: "https://i.ibb.co.com/m59kNmbL/12.png" },
                                    { name: "Rimon Ali", img: "https://i.ibb.co.com/m59kNmbL/12.png" },
                                    { name: "Zakir Nayak", img: "https://i.ibb.co.com/m59kNmbL/12.png" }
                                ].map((user, index) => (
